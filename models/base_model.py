"""
Original TDANet Architecture

This code is adapted from the official implementation of "TDANet: Top-Down 
Attention for Audio Separation" (ICLR 2023) by Kai Li, Runxuan Yang, and Xiaolin Hu.
Original repository: https://github.com/JusperLee/TDANet

Modifications for this project:
- Adapted the output head from 2-speaker speech to 4-stem polyphonic music 
  (Vocals, Drums, Bass, Other).
- Modified forward pass to support mono MUSDB18 audio chunks.
"""
...
@lru_cache()
def model_list(endpoint=huggingface_hub.HUGGINGFACE_CO_URL_HOME, name_only=False) -> Union[str, List[Dict]]:
